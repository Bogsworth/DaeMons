...
function returnSubJSON(
    ...
    function paramFilter (daemon, paramsRequired) {
        // return JSON.stringify(paramsRequired) == JSON.stringify(paramsRequired.filter(requirements => 
        //     daemon[requirements.param].includes(requirements.value)
        // ));
        /// ------------------
        let flag = true;
        ...
        // -----------------
        // return (
        //     daemon[paramsRequired[0].param].includes(paramsRequired[0].value) &&
        //     daemon[paramsRequired[1].param].includes(paramsRequired[1].value)
        // )
    }
